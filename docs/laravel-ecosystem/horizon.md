...
LaraKube CLI simplifies running [Laravel Horizon](https://laravel.com/docs/horizon) by handling the process management and Redis requirements automatically.
