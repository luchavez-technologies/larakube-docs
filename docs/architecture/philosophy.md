...
sidebar_position: 1
title: Philosophy
description: Explore the LaraKube CLI philosophy of architectural transparency, production-ready stability, and seamless local-to-cloud workflows for Laravel developers.
---
# Core Philosophy

LaraKube CLI is built on a **Container-First** philosophy. We believe that a developer's host machine should be kept as clean and "factory-original" as possible.

## ⚙️ The Orchestration Engine
LaraKube CLI's "No-Host-Dependency" model works by abstracting Kubernetes into a standalone binary:
...
LaraKube CLI assumes you don't have PHP, Composer, or Node installed on your Mac or Linux machine.
...
- **Automatic Mapping:** LaraKube CLI automatically detects your host's **User ID** and **Group ID**.
...
LaraKube CLI separates "Orchestration" (doing things) from "Management" (remembering things).
