...
sidebar_position: 1
title: Installation
description: Professional installation guide for LaraKube CLI. Learn how to install the standalone binary and prepare your environment for Laravel on Kubernetes.
---
# Installation
