...
For the full graduation story, see [Cloud Strategy](../architecture/CLOUD_STRATEGY), the [$6/mo Baseline](../deployment/6dollar-baseline), and [GitHub Actions](../deployment/github-actions) for CI/CD wiring.
:::
