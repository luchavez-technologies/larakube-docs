...
description: Secure your Laravel Kubernetes cluster with a Zero-Secrets-in-Git policy. Learn how LaraKube CLI handles environment sync and local data persistence.
---
...
3.  **Automatic Protection:** LaraKube CLI automatically ensures your environment files are ignored by Git.
...
-   **Production (Cloud PVC):** For non-local environments, LaraKube CLI automatically prepares robust PersistentVolumeClaims for your cloud provider (EBS, Block Storage, etc.), ensuring your data is durable and safe.
