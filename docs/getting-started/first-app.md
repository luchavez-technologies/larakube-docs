...
5.  **Databases:** Choose your foundation (SQLite, MySQL, MariaDB, or PostgreSQL).
...
- **App:** [https://my-awesome-app.local](https://my-awesome-app.local)
- **Mailpit:** [https://mailpit.my-awesome-app.local](https://mailpit.my-awesome-app.local)
- **Meilisearch:** [https://meilisearch.my-awesome-app.local](https://meilisearch.my-awesome-app.local) (If enabled)
